    ...
    <>
      ...
      <div className="w-full bg-white relative z-1016" data-aos="fade-up">
        <div className="w-[90%] lg:w-[68%] mx-auto pt-4 pb-4 md:pt-6 md:pb-6">
          ...
          <div className="grid grid-cols-3 md:flex md:flex-wrap justify-items-center items-center gap-y-8 gap-x-4 sm:gap-12 md:gap-8 lg:gap-10 opacity-100 grayscale-0 transition-all duration-300" data-aos="fade-up">
            {/* McDonalds */}
            <img 
